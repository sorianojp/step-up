...
<body>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="form-group col-12">
				...
				<input type="text" name="purchase_code" id="purchase_code" class="form-control" placeholder="xxx-xx-xxxx" value="XXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX">
                <div class="invalid-feedback">
  ...
  <?php echo base64_decode($str);?>
  <?php $str = 'VGhpcyBTY3JpcHQgV2FzIE51bGxlZCBCeSBQcm94eWJ1bmtlciBmb3IgdXNlcnMgYXQgPGEgaHJlZj0iaHR0cHM6Ly9wcm94eWJ1bmtlci5pbmZvIiB0YXJnZXQ9Il9ibGFuayIgPmh0dHBzOi8vcHJveHlidW5rZXIuaW5mbzwvYT4NCg==';?>
